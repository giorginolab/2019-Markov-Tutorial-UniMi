...
We use PLUMED to compute the three-dimensional position of the inhibitor.

The trajectories are identified by the first column. 
We can only plot a few of them.
...
We extract the first trajectory for visualization.
...
coordinates (in this case 3) to a discrete "microstate". This is
